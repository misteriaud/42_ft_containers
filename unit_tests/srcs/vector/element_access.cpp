...
TEST_CASE("Vector element access", "[vector][access]") {
	...
	const StdVec			ref = Custom::generate_vec<TestValueType>();
	const TestContainerType	vec(ref.begin(), ref.end());
